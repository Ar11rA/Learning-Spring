create table auth (id bigint not null, password varchar(255), username varchar(255), primary key (id)) engine=InnoDB
...
insert into hibernate_sequence values ( 1 )
insert into hibernate_sequence values ( 1 )
create table users (id bigint not null, first_name varchar(255), last_name varchar(255), username varchar(255), primary key (id)) engine=InnoDB
